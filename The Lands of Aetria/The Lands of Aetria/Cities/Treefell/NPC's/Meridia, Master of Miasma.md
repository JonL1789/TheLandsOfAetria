...
(This imposition allows Meridia to fly 30 FT, use Glavo De Putro, and anyone who uses a melee attack against Meridia will have disadvantage on a failed DEX save. 
	After saving the DEX save, the miasmic chains will not force another save until the victim's next turn.)

New Ability: ==**Grasping Miasma**==
- Passive Ability
	- Anybody who attempts to move while standing within the Imposition will have to roll a DC 17 DEX save
		- On a fail, the victim will be grasped by Miasmic Chains emanating from the floor, dealing **2d6** necrotic damage, alongside halting any movement for the turn.
New Ability: ==**Protective Tar**==
- As a reaction, Meridia will shield himself with Miasma, taking only half damage from an incoming melee attack that would hit. The miasma would emanate from his ***Wing.***
	- Catching it within himself, his Miasma would tarnish and taint the attacker's weapon, forcing them to be inflicted with **Life-seeking Miasma**.
		- For those using a Ranged weapon, [[Meridia, Master of Miasma]] will summon his miasma to coat their gun. 
...
Meridia has one legendary resistance, and can use it to succeed a save he would otherwise fail. 


Entry #3, *A Proposition*
- Enibras came to treefell when Meridia was serving under the old ruler of Treefell, Elias.
- In their battle between Treefell and Enibras, Elias and the rest of his guard were snuffed out completely.
- Meridia, however, was one of great potential, and Enibras sensed he would be one to agree to a contract.
